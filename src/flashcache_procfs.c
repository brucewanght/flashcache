...
#endif
=======
static int flashcache_io_latency_init(struct ctl_table *table, int write,
                           void __user *buffer,
                           size_t *length, loff_t *ppos)
{
    struct cache_c *dmc = (struct cache_c *)table->extra1;
...
static int flashcache_sync_sysctl(struct ctl_table *table, int write,
                       void __user *buffer,
                       size_t *length, loff_t *ppos)
{
    struct cache_c *dmc = (struct cache_c *)table->extra1;
...
static int flashcache_zerostats_sysctl(struct ctl_table *table, int write,
                            void __user *buffer,
                            size_t *length, loff_t *ppos)
{
    struct cache_c *dmc = (struct cache_c *)table->extra1;
...
static int flashcache_fallow_clean_speed_sysctl(struct ctl_table *table, int write,
                                     void __user *buffer,
                                     size_t *length, loff_t *ppos)
{
    struct cache_c *dmc = (struct cache_c *)table->extra1;
...
static int flashcache_dirty_thresh_sysctl(struct ctl_table *table, int write,
                               void __user *buffer,
                               size_t *length, loff_t *ppos)
{
    struct cache_c *dmc = (struct cache_c *)table->extra1;
...
static int flashcache_lru_hot_pct_sysctl(struct ctl_table *table, int write,
                              void __user *buffer,
                              size_t *length, loff_t *ppos)
{
    struct cache_c *dmc = (struct cache_c *)table->extra1;
...
int* flashcache_find_sysctl_data(struct cache_c *dmc, struct ctl_table *vars)
{
    if (strcmp(vars->procname, "io_latency_hist") == 0)
        return &dmc->sysctl_io_latency_hist;
    else if (strcmp(vars->procname, "do_sync") == 0)
...
static void flashcache_writeback_sysctl_register(struct cache_c *dmc)
{
    int i;
    struct flashcache_writeback_sysctl_table *t;
...
static void flashcache_writeback_sysctl_unregister(struct cache_c *dmc)
{
    struct flashcache_writeback_sysctl_table *t;
...
static void flashcache_writethrough_sysctl_register(struct cache_c *dmc)
{
    int i;
    struct flashcache_writethrough_sysctl_table *t;
...
static void flashcache_writethrough_sysctl_unregister(struct cache_c *dmc)
{
    struct flashcache_writethrough_sysctl_table *t;
...
static int flashcache_stats_show(struct seq_file *seq, void *v)
{
    struct cache_c *dmc = seq->private;
    struct flashcache_stats *stats;
    int read_hit_pct, write_hit_pct, dirty_write_hit_pct;
...
static int flashcache_stats_open(struct inode *inode, struct file *file)
{
    return single_open(file, &flashcache_stats_show, PDE_DATA(inode));
}
...
static int flashcache_errors_show(struct seq_file *seq, void *v)
{
    struct cache_c *dmc = seq->private;
...
static int flashcache_errors_open(struct inode *inode, struct file *file)
{
    return single_open(file, &flashcache_errors_show, PDE_DATA(inode));
}
...
static int flashcache_iosize_hist_show(struct seq_file *seq, void *v)
{
    int i;
...
static int flashcache_iosize_hist_open(struct inode *inode, struct file *file)
{
    return single_open(file, &flashcache_iosize_hist_show, PDE_DATA(inode));
}
...
static int flashcache_pidlists_show(struct seq_file *seq, void *v)
{
    struct cache_c *dmc = seq->private;
    struct flashcache_cachectl_pid *pid_list;
    unsigned long flags;
...
static int flashcache_pidlists_open(struct inode *inode, struct file *file)
{
    return single_open(file, &flashcache_pidlists_show, PDE_DATA(inode));
}
...
=======
static int flashcache_version_show(struct seq_file *seq, void *v)
{
    seq_printf(seq, "Flashcache Version : %s\n", flashcache_sw_version);
#ifdef COMMIT_REV
    seq_printf(seq, "git commit: %s\n", COMMIT_REV);
...
static int flashcache_version_open(struct inode *inode, struct file *file)
{
    return single_open(file, &flashcache_version_show, PDE_DATA(inode));
}
